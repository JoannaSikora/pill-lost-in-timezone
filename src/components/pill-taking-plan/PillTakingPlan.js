        ...
        <div className="PillTakingPlan_wrapper">
            ...
            <div className="PillTakingPlan_cards_wrapper">
                ...
                <div className="PillTakingPlan_cards_card">
                    <div className="PillTakingPlan_cards_card_title">Last pill <strong>before </strong>the arrival:
                    </div>
                ...
                <div className="PillTakingPlan_cards_card PillTakingPlan_cards_card--arrival">
                    ...
                    <div className="PillTakingPlan_cards_card_title">You arrive in {destinationCityName} at:
                        <br />
                        <strong
                            className="PillTakingPlan_cards_card--arrival_timezoneChange">  {timeDifferenceInMinutes === 0 ? 'NO TIMEZONE CHANGE' : 'CHANGE OF TIMEZONE'}</strong>
                    </div>
                ...
                <div className="PillTakingPlan_cards_card">
                    ...
                    <div className="PillTakingPlan_cards_card_title">First pill <strong>after</strong> the arrival:
                    </div>
                    <div className="PillTakingPlan_cards_card_time">
